...
def high_frequency_data():
    ...
    df_data_AAPL['CloseBidSize'] = df_data_AAPL['CloseBidSize'].round(2)
    df_data_AAPL['CloseAskSize'] = df_data_AAPL['CloseAskSize'].round(2)
    df_data_AAPL['CloseBidPrice'] = df_data_AAPL['CloseBidPrice'].round(2)
    df_data_AAPL['CloseAskPrice'] = df_data_AAPL['CloseAskPrice'].round(2)
    df_data_AAPL['WeightedMidPrice'] = df_data_AAPL['WeightedMidPrice'].round(2)
    df_data_JPM['CloseBidSize'] = df_data_JPM['CloseBidSize'].round(2)
    df_data_JPM['CloseAskSize'] = df_data_JPM['CloseAskSize'].round(2)
    df_data_JPM['CloseBidPrice'] = df_data_JPM['CloseBidPrice'].round(2)
    df_data_JPM['CloseAskPrice'] = df_data_JPM['CloseAskPrice'].round(2)
    df_data_JPM['WeightedMidPrice'] = df_data_JPM['WeightedMidPrice'].round(2)
    df_data_AAPL['AAPL_rr'] = df_data_AAPL['AAPL_rr'].round(2)
    df_data_JPM['JPM_rr'] = df_data_JPM['JPM_rr'].round(2)
    df_data_AAPL['AAPL_lr'] = df_data_AAPL['AAPL_lr'].round(2)
    df_data_JPM['JPM_lr'] = df_data_JPM['JPM_lr'].round(2)
